...
export const keepWeaponSettingsSelector = createSelector(
  ...
  (searchSettings) => searchSettings?.keepWeapon || initialSettingsState.searchFilterSettings?.keepWeapon
);

export const keepArmorSettingsSelector = createSelector(
  searchFilterSettingsSelector,
  (searchSettings) => searchSettings?.keepArmor || initialSettingsState.searchFilterSettings?.keepArmor
);