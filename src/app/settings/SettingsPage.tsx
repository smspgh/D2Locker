...
// Configuration to control which settings are visible
...
const SETTINGS_VISIBILITY = {
  ...
  sortOptions: {
    ...
    name: true, // Show Name
    tag: false,
    season: true, // Show Season (D2)
    acquisitionRecency: true, // Show Recently Acquired (D2)
    elementWeapon: false,
    masterworked: false,
    crafted: false,
    deepsight: false,
  ...
  dupeNotice: false, // Hide duplicate items notice
  perkDisplay: false, // Hide Perk display in item popup
  syncLockState: false, // Hide Sync item lock state with tag
  singleCharacterMode: false, // Hide Single-Character View section
  characterSort: {
    mostRecent: true,
        ...
        <form>
          ...
          <section id="items">
            ...
            <div className={styles.setting}>
              ...
              {SETTINGS_VISIBILITY.dupeNotice && (
            ...
            {SETTINGS_VISIBILITY.perkDisplay && (
              <div className={styles.setting}>
          ...
          <section id="inventory">
            ...
            {SETTINGS_VISIBILITY.singleCharacterMode && (
              <div className={styles.setting}>
                <Checkbox
            ...
            {!settings.singleCharacter && (
              <div className={styles.setting}>
                ...
                <ul className={styles.radioOptions}>
                  {SETTINGS_VISIBILITY.characterSort.mostRecent && (
                    <li>
                      <label>
                        <input
                          type="radio"
                  ...
                  {SETTINGS_VISIBILITY.characterSort.mostRecentReverse && (
                    <li>
                      <label>
                        <input
                          type="radio"
                  ...
                  {SETTINGS_VISIBILITY.characterSort.fixed && (
                    <li>
                      <label>
                        <input
                          type="radio"
            ...
            {SETTINGS_VISIBILITY.inventoryColumns && (
              <div className={styles.setting}>
                {isPhonePortrait ? (
                  <>
                    <Select
            ...
            {SETTINGS_VISIBILITY.hideCollectPostmaster && (
              <div className={styles.setting}>
                <Checkbox
            ...
            {SETTINGS_VISIBILITY.badgePostmaster && (
              <div className={styles.setting}>
                <Checkbox
            ...
            {SETTINGS_VISIBILITY.farmingModeSpaces && (
              <div className={styles.setting}>
                <Select
