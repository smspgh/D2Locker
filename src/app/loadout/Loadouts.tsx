...
import { apiPermissionGrantedSelector, languageSelector } from 'app/d2l-api/selectors';
...
import { VirtualListRef, WindowVirtualList } from 'app/d2l-ui/VirtualList';
    ...
    <PageWithMenu>
      ...
      <PageWithMenu.Contents>
        {$featureFlags.warnNoSync && !apiPermissionGranted && (
          <p>
            <AlertIcon /> {t('Storage.D2LSyncNotEnabled')}
          </p>
        )}
        {!filteringLoadouts && (
          <InGameLoadoutStrip
