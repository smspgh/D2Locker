...
const DIM_API_HOST =
  $DIM_FLAVOR === 'dev' ? 'https://localhost/api' : 'https://shirezaks.com/api';
export const API_KEY = '788600d2-9320-484e-86dd-5f5c9c458b66'; // Hardcoded for private use - This is our DIM API Key
