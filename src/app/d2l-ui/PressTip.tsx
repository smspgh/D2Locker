...
export function useTooltipCustomization({
  ...
  /**
   * A function that returns the content to be rendered in the tooltip's subheader (d2lmed text below the
...
export const Tooltip = {
  ...
  /**
   * A convenience component used to customise the tooltip's subheader (d2lmed text below the header) from
