...
const globalSettingsSelector = (state: RootState) => state.d2lApi.globalSettings;
 ...
 * "sneaky updates" where D2L will try to reload itself if it becomes invisible while
 * it needs an update.
 *
  ...
  useEffect(() => {
    const visibilityHandler = () => {
      if (!document.hidden) {
        ...
        d2lNeedsUpdate$.getCurrentValue() &&
        ...
        // Sneaky updates - if D2L is hidden and needs an update, do the update.
        reloadD2L();
      }
    };
