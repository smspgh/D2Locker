...
module.exports = {
  ...
  transform: function customTransform(file, enc, done) {
    ...
    // prettier-ignore
    const keys = {
      buckets: { list: ['General', 'Inventory', 'Postmaster', 'Progress', 'Unknown', 'Consumables', 'Modifications'] },
    ...
    const d2lTransformer = (key, options) => {
    ...
    parser.parseFuncFromString(content, { list: ['t', 'tl', 'DimError'] }, d2lTransformer);
