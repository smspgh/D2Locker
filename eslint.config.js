...
export default tseslint.config(
  ...
  // TypeScript-specific configuration
  {
    ...
    rules: {
      ...
      // @eslint-react rules (only for TypeScript files)
  ...
  // JavaScript-specific configuration (no TypeScript type checking)
  {
  ...
  // Backend-specific configuration
  {
    ...
    rules: {
      // Allow Node.js patterns
      'no-console': 'off',
      '@typescript-eslint/no-unused-vars': 'off',
      // Use standard no-unused-vars for JS files
  ...
  },
  {
    ...
    ignores: [
      ...
      'auto-install-missing-deps.js',
      'compare-files.js',
      'docker-hmr-server.js',
      'find-missing-deps.js',
      'install-react-aria-deps.js',
      'install-react-stately-deps.js',
      'proxy-server.js',
      ...
      'src/browsercheck.js',
      'src/earlyErrorReport.js',
    ],
  },
  {
    name: 'd2l-custom-common',
    languageOptions: {
      ecmaVersion: 'latest',
      parserOptions: {
        ecmaVersion: 'latest',
      ...
      globals: {
        ...
        ga: 'readonly',
        $D2L_FLAVOR: 'readonly',
        $D2L_VERSION: 'readonly',
        $D2L_BUILD_DATE: 'readonly',
        $D2L_WEB_API_KEY: 'readonly',
        $D2L_WEB_CLIENT_ID: 'readonly',
        $D2L_WEB_CLIENT_SECRET: 'readonly',
        $D2L_API_KEY: 'readonly',
        $BROWSERS: 'readonly',
        workbox: 'readonly',
        React: 'readonly',
        require: 'readonly',
